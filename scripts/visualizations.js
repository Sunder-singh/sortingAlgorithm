...
function vspeed()
{
    ...
    //Decreases numerator to increase the speed of algorithm
}

var delay_time=10000/(Math.floor(array_size/10)*speed);
var delay =0; 
//dealy is updated over every div change so that the visualisation is visible
...
function update(cont,height,color){
    window.setTimeout(function(){
        cont.style=" margin:  " + margin_size + "%; width:" + (100/array_size-(2*margin_size)) + "%; height:" + height + "%; background:" + color + ";";
    },delay+=delay_time);
}
